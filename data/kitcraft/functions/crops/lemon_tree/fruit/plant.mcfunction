...
execute as @e[type=armor_stand,tag=kitcraft_lemon_tree_fruit_init,distance=..50] at @s positioned ~ ~-1 ~ align xyz as @e[tag=kitcraft_lemon_tree_fruit] at @s unless score @s kc_req_g_time matches 1.. run function kitcraft:crops/lemon_tree/fruit/set_growth_time
